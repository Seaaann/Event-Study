...
def eventstudy(returndata, eventdata, stocklist):
    ...
    for stock in stocklist:
        ...
        print(eventindex)
        event_df = returndata.loc[eventindex-10: eventindex+10, ['Date', stock , 'RF', 'Mkt_RF']]
        estimation_df  = returndata.loc[eventindex-260: eventindex-11, ["Date", stock, 'RF', 'Mkt_RF']]
